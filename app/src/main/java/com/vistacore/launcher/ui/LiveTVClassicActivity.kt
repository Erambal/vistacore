...
class LiveChannelAdapter(
    ...
    /** Long-press OK / DPAD_CENTER on a channel — opens the channel context menu
     *  (favorite toggle + go-to-channel). Single gesture covers both actions
     *  without competing with D-pad navigation. */
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        // Long-press OK / DPAD_CENTER opens the channel context menu.
        // No DPAD_RIGHT handler — it would conflict with horizontal
        // navigation in the ribbon / grid / carousel variants, so all
        // layouts share this menu-based approach for consistency.
